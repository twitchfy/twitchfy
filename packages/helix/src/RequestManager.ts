...
export class RequestManager {
    ...
    public async get(endpoint: string, params: string, userToken?: string) {
    ...
    public async postWithUserToken(endpoint: string, params: string, body: WhisperBody | BanBody | TimeoutBody | AnnouncementBody | null , userToken?: string) {
    ...
    public async patchWithUserToken(endpoint: string, params: string, body: ChatSettingsBody, userToken?: string){
    ...
    public async putWithUserToken(endpoint: string, params: string, body?: AutoModSettingsBody, userToken?: string){
