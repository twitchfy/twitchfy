import { User, Channel, Ban, ChatSettings, GetBan, PostBanBody, PostBanData, PatchChatSettings, PostWhisperBody, AutoModSettings, PutAutoModSettings, Chatter, GetFollowers, PostCreateClip, GetStream } from "@twitchapi/api-types"
...
declare module "@twitchapi/helix" {
    ...
    export class RequestManager {
        ...
        public get(endpoint: string, params: string, userToken?: string): Promise<any>
        public deleteWithUserToken(endpoint: string, params: string, userToken?: string): void
        public postWithUserToken(endpoint: string, params: string, body: WhisperBody | BanBody | TimeoutBody | AnnouncementBody | null, userToken?: string): Promise<any>
        public patchWithUserToken(endpoint: string, params: string, body: ChatSettingsBody | null, userToken?: string): Promise<any>
        public putWithUserToken(endpoint: string, params: string, body?: AutoModSettingsBody, userToken?: string): Promise<any>
    ...
    export class BaseClient {
        ...
        public getStream(user_id: string | null, user_login?: string): Promise<GetStream | null>
